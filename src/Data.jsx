const Data = [
    ...
    },
    {
        ...
        description: 'Rumour also has it that users might be able to edit messages for a certain time period. It looks like the ability to edit sent messages is still under development. As part of the WhatsApp beta for Android 2.22.20.12 update, the edit message functionality is not available to beta testers right now.'
    },
    {
        id: '18',
        category: 'Technology',
        ...
        description: 'Nvidia Corp., the most valuable semiconductor maker in the US, unveiled a new type of graphics chip that uses enhanced artificial intelligence to create more realistic images in games.Codenamed Ada Lovelace, the new architecture underpins the company’s GeForce RTX 40 series of graphics cards, unveiled by co-founder and Chief Executive Officer Jensen Huang at an online event Tuesday.'
    },
    {
        id: '19',
        category: 'Technology',
    ...
    },
    {
        ...
        description: 'As the 3.5mm audio jack makes its way out of our tech lives, most of us are increasingly turning to Bluetooth options for our audio needs. However, one generally has to pay a significant amount to get a pair of Bluetooth earphones that deliver good quality audio. Which is why the Sennheiser CX 120BT are an almost unbelievable deal at their current price of Rs 999.'
    },
    {
        id: '21',
        category: 'Hollywood',
        imgUrl: 'https://i.pinimg.com/736x/d5/f9/15/d5f9152f51f55fced203b43f1f82a56f.jpg',
        title: 'Johnny Depp doppelganger with similar hairstyle and goatee spotted in Iran',
        description: 'Johnny Depp fans are stunned as the actor’s doppelganger was spotted at a religious ceremony in Iran. The man’s video was captured as he attended a festival in Tabriz, Iran. The said video first reportedly appeared on TikTok before being shared on other platforms like Twitter and Reddit, with many social media users saying they were surprised to see Johnny’s lookalike sporting the actor’s distinctive hair and goatee.'
    },
    {
        id: '22',
        category: 'Hollywood',
    ...
    },
    {
        id: '23',
        category: 'Hollywood',
        imgUrl: 'https://cdn.vanguardngr.com/wp-content/uploads/2022/09/039B1F28-EDA1-4AF7-A8B3-B6490C01D709.jpeg?width=600&auto_optimize=medium',
        title: 'Isaiah Washington',
        description: 'When it comes to international partnerships and working with some of the largest names in the global entertainment scene, the entertainment business has done fairly well.Many Nigerian celebrities have made their debuts in foreign films, much like a handful of Hollywood stars, like Isaiah Washington, Vivica Fox, and Kim Basinger, have appeared in Nollywood movies.'
    },
    {
        id: '24',
        category: 'Hollywood',
        imgUrl: 'https://richmondstandard.com/wp-content/uploads/2022/09/FatherStu.jpg',
        title: 'Hercules actor dishes on working on Hollywood movie Father Stu',
        description: 'The movie is a biographical drama starring Wahlberg that tells the story of Stuart Long, a non-Catholic boxer who enters seminary school after having a life-altering experience. Saravia plays a seminary student and said he filmed his scenes over four days on location in Agoura Hills and Calabasas, Calif.Some of those scenes were with Wahlberg, one of his childhood heroes growing up from past movies like Ted, Transformers and The Other Guys.'
    },
    {
        id: '25',
        category: 'Hollywood',
    ...
    },
    {
        id: '26',
        category: 'Hollywood',
        imgUrl: 'https://imagevars.gulfnews.com/2022/09/19/Juliette-Binoche_18354960504_large.JPG',
        title: 'Actress Juliette Binoche urges actors to reject roles that objectify women',
        description: 'Actors must learn to just say “no” to roles that objectify women, Oscar-winning French actor Juliette Binoche said Sunday at the San Sebastian film festival where she will be honoured with an award for her acting career.“You have to know how to say no to things so that you don’t end up in a kind of situation where you are seen in a certain way,” said Binoche, who is one of France’s most recognised actors.'
    },
    {
        id: '27',
        category: 'Hollywood',
        imgUrl: 'https://m.media-amazon.com/images/M/MV5BMTY1NzMyODc3Nl5BMl5BanBnXkFtZTgwNzE2MzA1NDM@._V1_UY317_CR87,0,214,317_AL__QL50.jpg',
        title: 'Kevin Spacey',
        description: 'Kevin Spacey Fowler, better known by his stage name Kevin Spacey, is an American actor of screen and stage, film director, producer, screenwriter and singer. He began his career as a stage actor during the 1980s before obtaining supporting roles in film and television. He gained critical acclaim in the early 1990s that culminated in his first Academy Award for Best Supporting Actor for the neo-noir crime thriller The Usual Suspects (1995), and an Academy Award for Best Actor for midlife crisis-themed drama American Beauty (1999).'
    },
    {
        id: '28',
        category: 'Hollywood',
        imgUrl: 'https://m.media-amazon.com/images/M/MV5BYzU0ZGRhZWItMGJlNy00YzlkLWIzOWYtNDA2NzlhMDg3YjMwXkEyXkFqcGdeQXVyMDM2NDM2MQ@@._V1_UX214_CR0,0,214,317_AL__QL50.jpg',
    ...
    },
    {
        id: '29',
        category: 'Hollywood',
        imgUrl: 'https://m.media-amazon.com/images/M/MV5BMTAzMjI0NzgzMDleQTJeQWpwZ15BbWU4MDY1ODE2NzYx._V1_UX214_CR0,0,214,317_AL__QL50.jpg',
        title: 'Christine Woods',
        description: 'Paternal granddaughter of Sterling Allen Woods (son of Roy Emmie Woods and wife Marion May Parish, paternal grandson of Ira Palmer Woods (son of Hannibal Woods and wife Electa Allen) and wife Nevina Georgiana Harris (daughter of Hiram Harris and wife Martha J. Weaver) and maternal grandson of Fred Parish (son of John Parish and wife Clara S. Hill) and wife Ora DeWolf (daughter of Myron DeWolf and wife Julia Gray of Clan Gray) and wife Sylvia Mary Ostrowski (daughter of John Aloysius Ostrowski (b. Minnesota) and wife Mary Sobota (b. Minnesota, daughter of Polish parents) and paternal granddaughter of Stanislaw Ostrowski (b. Poland, Russia)'
    },
    {
        id: '30',
    ...
    },
    {
        id: '31',
        category: 'Fitness',
        imgUrl: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/fitness-trends-2022-1641306495.jpg?crop=0.893xw:1.00xh;0.0561xw,0&resize=1600:*',
        title: 'Be fit',
        description: 'Mental health has been a crucial concern after several lockdowns, financial challenges, and overall stress from living through a pandemic. Yoga, meditation, and tai-chi will continue to be popular as more individuals explore ways to relieve stress and anxiety, and support their mental health. Fitness enthusiasts will look to accomplish their overall wellness goals as physical exercise becomes more integrated into the larger health puzzle.'
    },
    {
        id: '32',
        category: 'LatestArticle',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/12/31100125/fitness-trends-770x433.jpg',
        title: 'Focus on fitness these days !',
        description: 'As the New Year approaches, there is an expectation of the emergence of a new wave of fitness trends. While home workouts aren’t going anywhere, the way people think about well-being has changed. People are concentrating not only on how they exercise, but also on why they exercise.As a consequence of that, the interest in fitness has grown. While gyms are restoring their full capacity, the demand for exercise in practically every other sector has never been higher.'
    },
    {
        id: '33',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/12/27163442/fitness-challenge-770x433.jpg',
        title: 'Stay healthy for a better tommorrow',
        description: 'As countries implemented lockdowns to prevent the spread of the virus, forcing temporary closures of gyms and studios, fitness programmes began to migrate to online platforms. Users can join live-streaming lessons with their friends or join new classes to meet new people. These online classes later proved to be incredibly adaptable. Those with hectic schedules could watch recorded courses at their leisure.'
    },
    {
        id: '34',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/09/03142933/Tadasana-627x354.jpg',
        title: 'Low impact exercises',
        description: 'Rowing, yoga, and Pilates are excellent strength-building exercises that are also gentle on the body. Low-impact but effective workouts will continue to be a fitness trend as more people want to improve their functional everyday movements and live healthier lives. Pure Barre, for example, the world’s largest barre studio brand, focuses on subtle motions that lead to significant changes.'
    },
    {
        id: '35',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/09/06145503/shutterstock_1563301450-627x354.jpg',
        title: 'Gaining strength',
        description: 'Experts believe that interactive strength training equipment, such as NordicTrack’s Vault, Tempo, and Tonal, mirror-style gadgets fully equipped with everything needed for effective workouts, will become more popular in 2022. Personal training apps also provide one-on-one sessions and customised workouts with pros for a fraction of the cost of a regular gym membership for people who already have all the necessary equipment.'
    },
    {
        id: '36',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/06/09130231/exercising-after-a-break-627x354.png',
        title: 'Cool down after exercise by stretching',
        description: 'If a person with asthma is not used to exercise like running, jogging, or soccer, having a fitness exercise may be too much for them at once. Exercise should be avoided in cold, dry surroundings. Exercising in cold conditions, such as ice hockey, skiing, and other winter activities, is more likely to trigger asthma flare-ups,” '
    },
    {
        id: '37',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/12/23103636/kubbra-770x433.jpg',
        title: 'Welcome the New Year with this power-packed workout sesh by Kubbra Sait.',
        description: 'Kubbra Sait is a work in progress, just like all of us. The actor loves her time in the gym and is often spotted engrossed in her fitness routine. When not playing characters for the screen, Kubbra is opted seen working on her body with an intense workout routine. Kubbra’s Instagram profile is replete with pictures and videos of herself practising her fitness routine and they are a treat for sore eyes'
    },
    {
        id: '38',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/12/09222825/running1-770x433.jpg',
        title: 'Not every exercise or workout will essentially result in a mass buildup.',
        description: 'Muscles play an important role in the daily functioning of your body. Muscles allow us to breathe, lift, stand, balance, and walk. Focusing on building muscles is important for both men and women as they help our body to perform well, avoid pains, prevent falls, and wear and tear. Muscle mass plays a vital role in dense bones, increased overall energy levels and optimal calorie burn rate.'
    },
    {
        id: '39',
        category: 'Fitness',
        imgUrl: 'https://www.healthshots.com/wp-content/uploads/2020/09/muscle-gain-1-627x354.jpg',
        title: 'Exercises that restrict muscle gain',
        description: 'Sourabh Arya, a New Delhi-based fitness expert and nutritionist, tells HealthShots about the exercises we need to limit to prevent muscle loss.Recognise that too much endurance activity and bouts of exercise that are too long can cause loss of lean muscle mass, especially, during periods of caloric restriction or if you are Ectomorph (too skinny)'
    },
    {
        id: '40',
        category: 'Fitness',
        imgUrl: 'https://images.healthshots.com/healthshots/en/uploads/2021/12/09105718/hold-yoga-pose-770x433.jpg',
        title: 'Unable to hold yoga poses?',
        description: 'If holding a yoga pose for long is a problem, turn to these four yoga poses that have a solution. Read, perform, and get back in shape.And when it comes to yoga, holding a pose is what matters the most. The longer you hold, the more toned your body gets.Holding a yoga posture requires a few elements like strength, flexibility, balance, a strong core and the ability to breathe through the long duration of a hold.'
    },
    {
        id: '41',
        category: 'LatestArticle',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-1.jpg',
        title: 'Trending trends',
        description: 'having a very clear identity and making sure all business decisions are in line with it. If, for example, you’re a meat-centric venue, offering a range of new vegan-friendly dishes isn’t going to help you. It would be off-brand and, frankly, confusing to guests.'
    },
    {
        id: '42',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-2.jpg',
        title: 'Plant based cuisine eats to try on your menu',
        description: 'As rapid population growth puts a strain on natural resources and food supplies, the days of wasting food are over. Nose-to-tail and leaf-to-root cooking are gaining momentum, and restaurants are now finding creative ways to make food go further.Meat-free burgers.Vegan ice creams.Cauliflower buffalo wings'
    },
    {
        id: '43',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-5.jpg',
        title: 'Kombucha trends to try on your menu',
        description: 'Kombucha – fermented sweet tea with a culture of yeast and bacteria – is becoming known for its health benefits. It contains antioxidants and beneficial probiotics and can rid your body of harmful bacteria.While drinking kombucha is already trendy – with people buying kombucha kits online – this tendency will only grow as more people become aware of the benefits and restaurants start offering this tasty drink.'
    },
    {
        id: '44',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-6.jpg',
        title: 'Superfood powder trends you can try on your menu this year',
        description: 'People following a keto diet typically avoid high sugary foods like honey, syrups, sweet yogurts or juices, as well as grains and starches, chips and crackers, and many baked goods, to name a few. While this diet is promoted as a way to improve health and lose and manage weight, some experts may argue that it’s restrictive and even extreme, pointing to the dangers of consumers following it strictly.'
    },
    {
        id: '45',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-7.jpg',
        title: 'Keto trends to try on your menu',
        description: 'With many embracing the keto diet year after year, food products that identify as “keto” are gaining prominence. But what exactly is the keto diet based on? Often referred to as the “low-carb diet”, keto typically includes foods that are high in protein and fat, and lower in carbohydrates. According to Healthline, the reduction in carbs puts your body in a metabolic state where it’s more likely to burn fat efficiently. This process is referred to as “ketosis”.'
    },
    {
        id: '46',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-8.jpg',
        title: 'Cold Brew Coffee Set to Explode',
        description: 'But how is cold brew different than iced coffee?While iced coffee is brewed hot and then poured over ice, cold brew uses time instead of heat, letting the drink steep for about half a day at room temperature.Starbucks and Dunkin’ Donuts who now heavily promote their cold brew drinks.Cold brew old fashioned.Cold brew smoothie.'
    },
    {
        id: '47',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-10.jpg',
        title: 'Alternative coffee brewing trends',
        description: 'Modern coffee is evolving.Across the board, people want amazing experiences, have more discerning tastes, and are looking to build their knowledge – especially in the world of coffee.To satisfy this evolution, coffee shops, roasteries, and restaurants are focusing on craftsmanship and alternative coffee brewing methods. They’re also drawing customers fully into the coffee world by showing them how to make these carefully crafted brews.'
    },
    {
        id: '48',
        category: 'Food',
        imgUrl: 'https://www.touchbistro.com/wp-content/uploads/2020/11/food-trends-inset-11.jpg',
        title: 'Origin trends',
    ...
    },
    {
        ...
        title: 'IN COPENHAGEN',
        description: 'It’s modern and sophisticated yet charming, boasting a vibrant nightlife and plenty of activities to keep you entertained (be sure to explore the canals and spend some time having fun at Tivoli Gardens, the local amusement park).But the city is also pricey.'
    },
    {
        id: '55',
        category: 'Latest',
    ...
    },
    {
        id: '56',
        category: 'Travel',
        imgUrl: 'https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/static/optimized/rev-d225bf7/images/best-travel-blogs-budget.jpg',
        title: 'Budget Traveller',
        description: 'Travel is expensive, but these travelers show you how to make the most of your budget on the road while sharing fun travel stories from around the world.One of the best resources for budget travel. Kash has a unique niche of making budget travel glamorous and luxurious. He shares travel tips for living in luxury while saving money.'
    },
    {
        id: '57',
        category: 'Travel',
        imgUrl: 'https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/static/optimized/rev-d225bf7/images/best-travel-blogs-canada.jpg',
        title: 'Canadian Travellers',
        description: 'Canadians take up a lot of real estate on the Internet in the world of Travel Bloggers. While going through our list, we noticed that a lot of our favorite travelers are Canadian! (Psst, there are other Canadian Blogs listed throughout this list. We’ve bolded them. How many can you find? )Sharing the best food from around the world and how to make it at home. We’ve been following Ayngelina’s travel stories for nearly a decade.'
    },
    {
        id: '58',
        category: 'Travel',
        imgUrl: 'https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/static/optimized/rev-d225bf7/images/best-travel-blogs-couples-2.jpg',
        title: 'Travel Couples',
        description: 'Couple’s Coordinates – Alex and Michael call Southern California home, but travel the world 50% of the year. We love the way they capture the beauty of travel through their travel blog. The have som great photography on their blog.'
    },
    {
        id: '59',
        category: 'Travel',
        imgUrl: 'https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/static/optimized/rev-d225bf7/images/best-travel-blogs-lgbtq.jpg',
        title: 'Peace of mind with travel',
        description: 'We love beautiful photography. These are the photography blogs that that stand out to us and not only share beautiful photos from around the world, but travel tips, travel advice and solid photography information.'
    },
    {
        id: '60',
        category: 'Travel',
